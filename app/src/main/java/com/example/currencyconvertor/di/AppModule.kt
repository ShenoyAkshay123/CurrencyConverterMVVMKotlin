...
import com.example.currencyconvertor.main.DefaultMainRepository
import com.example.currencyconvertor.main.MainRepository
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun providesDispatchers(): DispatcherProviderInterface = object : DispatcherProviderInterface{
